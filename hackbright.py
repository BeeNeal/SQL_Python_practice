...
def get_project_by_title(title):
    ...
    db_cursor = db.session.execute(QUERY, {'title_value': title})
...
def get_grade_by_github_title(github, title):
    ...
    grade = db_cursor.fetchall()[0][0]

    print "The grade {} received for {} is {}".format(github, title, grade)
...
def assign_grade(github, title, grade):
    ...
    print "Grade of {} for {} successfully assigned to {}".format(grade,
                                                                  title, github)
...
def handle_input():
    ...
    while command != "quit":
        ...
        elif command == "get_grade_by_github":
            github, title = args
